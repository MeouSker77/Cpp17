...
\subsection{后记}
\hyperref[ch8.1]{嵌套命名空间定义}最早由Jon Jagger于2003年在
\url{https://wg21.link/n1524}中提出。
...
最终被接受的提案由Gabriel Dos Reis发表于\\
\url{https://wg21.link/p0138r2}。
...
\nameref{ch8.5}最早由Thomas Köppe在\url{https://wg21.link/p0245r0}
中首次提出。
...
\nameref{ch8.7}由Jens Maurer在\url{https://wg21.link/n4320}\\
中首次提出。
...
由Clark Nelson和Richard Smith作为\\
\url{https://wg21.link/p0061r0}的部分内容提出。
最终被接受的提案由Clark Nelson和Richard Smith发表于\url{https://wg21.link/p0061r1}。
