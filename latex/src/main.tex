...
\usepackage[colorlinks, linkcolor=black, breaklinks=true]{hyperref} % 交叉引用
...
\usepackage[a4paper, left=2cm, right=2cm, bottom=3.7cm]{geometry} % 设置页边距
...
\setlist{noitemsep} % 设置列表项间垂直间距为0
...
language = [11]C++,                  % 编程语言
stringstyle=\color{magenta},         % 字符串样式
